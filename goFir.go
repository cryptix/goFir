...
#include <stdlib.h>
	...
	void frame565() {
		...
		uint64_t t1=t0 & 0xffll;//cast_uint[targetSize=8,currentSize=32]
	...
	void frame582() {
		...
		//loadInternal[internalIdx=13]
		uint64_t t4=(((int64_t)(t2 * t3)) << 48) >> 48;//mul[targetSizeWithType=33]
		...
		//loadInternal[internalIdx=7]
		uint64_t t7=(((int64_t)(t5 * t6)) << 48) >> 48;//mul[targetSizeWithType=33]
		uint64_t t8=(((int64_t)(t4 + t7)) << 48) >> 48;//plus[targetSizeWithType=33]
		...
		uint64_t t11=(((int64_t)(t9 * t10)) << 48) >> 48;//mul[targetSizeWithType=33]
		uint64_t t12=(((int64_t)(t8 + t11)) << 48) >> 48;//plus[targetSizeWithType=33]
		...
		uint64_t t15=(((int64_t)(t13 * t14)) << 48) >> 48;//mul[targetSizeWithType=33]
		uint64_t t16=(((int64_t)(t12 + t15)) << 48) >> 48;//plus[targetSizeWithType=33]
		int64_t c17=t16 << 56;
		uint64_t t17=c17 >> 56;
		//cast_int[targetSize=8,currentSize=16]
